 ...
 * @action: An action
 * @in_names: (element-type utf8) (transfer none): A #GList of in utf8
 * parameter names
 * @in_values: (element-type GValue) (transfer none) : A #GList of #GValues that
 * line up with @in_names and @in_types
 * @out_names: (element-type utf8) (transfer none): A #GList of in utf8
 * parameter names
 * @out_types: (element-type GType) (transfer none): A #GList of GType that
 * line up with @in_names
 * @out_values: (element-type GValue) (transfer full) (out): A #GList of
 * #GValue
 *
 ...
 * @in_names:  (element-type utf8) (transfer none): A #GList of in utf8
 * parameter names
 * @in_values: (element-type GValue) (transfer none) : A #GList of values that
 * line up with @in_names and @in_types
                                    ...
                                    gpointer                         user_data)
{
        ...
        g_return_val_if_fail (action, NULL);
        g_return_val_if_fail (callback, NULL);
        g_return_val_if_fail (g_list_length(in_names) == g_list_length(in_values), NULL);
 ...
 * @in_names: (element-type utf8) (transfer none): A #GList of in utf8
 * parameter names
 * @in_types: (element-type GType) (transfer none) : A #GList of GType that
 * line up with @in_names
 * @out_values: (element-type GValue) (transfer full) (out): A GList of GValues
 *
